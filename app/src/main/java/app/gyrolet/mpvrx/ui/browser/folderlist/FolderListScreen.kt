    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = stringResource(app.gyrolet.mpvrx.R.string.home_title),
                ...
                onCheckedChange = {
                  coroutineScope.launch(kotlinx.coroutines.Dispatchers.IO) {
                    ...
                    kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
                      if (lastPlayed != null && !isFabExpanded.value) {
                        MediaUtils.playFile(lastPlayed.filePath, context, "recently_played_fab")
                      } else {
