                ...
                LazyColumn(
                    ...
                    item {
                        PreferenceCard {
                            ...
                            val smoothBackAnimation by preferences.smoothBackAnimation.collectAsState()
                            SwitchPreference(
                                value = smoothBackAnimation,
                                onValueChange = preferences.smoothBackAnimation::set,
                                title = { Text("Smooth Back Animation") },
                                summary = {
                                    Text(
                                        text = if (smoothBackAnimation)
                                            "Smooth predictive back animation (rotation flash may appear)"
                                        else
                                            "No animation, clean exit (no flash rotation issue)",
                                        color = MaterialTheme.colorScheme.outline,
                                    )
                                },
                            )
