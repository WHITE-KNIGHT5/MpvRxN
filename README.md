<h1 align="center">Working hard on it, I'll release the apk & add description for this fork within 5 days</h1>
...
- **Long-press to go top** — Long-press the folder name/title bar to scroll to top of a folder.
